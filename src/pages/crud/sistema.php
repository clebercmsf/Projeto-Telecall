...
//   $data = $_GET['search'];
//   $sql = "SELECT * FROM usuario WHERE id LIKE '%$data%' or nome LIKE '%$data%' or username LIKE '%$data%' ORDER BY id_Usuario DESC";
// } else {
...
<body>
  <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
    <div class="container-fluid">
      <a class="navbar-brand" href="../home/home.php">USUARIOS TELECALL</a>
