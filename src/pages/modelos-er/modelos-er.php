...
<head>
  ...
  <link rel="stylesheet" href="./modelos-er.css">
...
<body>
  ...
  <section class="containerHeader">
    <div class="containerHeader-content">
      ...
      <p>Modelo de dados<br>entidade-relacionamento.</p>
  ...
  <section class="containerSection">
      <div class="container">
        <h1 id="map-h1">CONHEÇA NOSSO MODELO</h1>
...
<script src="./modelos-er.js"></script>
