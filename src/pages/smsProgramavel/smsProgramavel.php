...
<head>
  ...
  <link rel="stylesheet" href="./smsProgramavel.css">
...
<body>
  ...
  <section class="containerSection">
      <div class="container">
        <h1 id="map-h1">CONHEÇA O SMS PROGRAMÁVEL</h1>
        <img src="../../assets/img/smsProgramavel-page/smsProgramavel1.jpg" alt="smsProgramavel" id="panel">
        <img src="../../assets/img/smsProgramavel-page/smsProgramavel2.jpg" alt="smsProgramavel" id="panel">
        <img src="../../assets/img/smsProgramavel-page/smsProgramavel3.jpg" alt="smsProgramavel" id="panel">
        <img src="../../assets/img/smsProgramavel-page/smsProgramavel4.jpg" alt="smsProgramavel" id="panel">
        <img src="../../assets/img/smsProgramavel-page/smsProgramavel5.jpg" alt="smsProgramavel" id="panel">
      </div>
  </section>
...
<script src="./smsProgramavel.js"></script>
