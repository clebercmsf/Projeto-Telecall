...
<head>
  ...
  <link rel="stylesheet" href="./verifiedCalls.css">
...
<body>
  ...
  <section class="containerSection">
      <div class="container">
        <h1 id="map-h1">CONHEÇA O GOOGLE VERIFIED CALLS</h1>
        <img src="../../assets/img/verifiedCalls-page/verifiedCalls1.jpg" alt="verifiedCalls" id="panel">
        <img src="../../assets/img/verifiedCalls-page/verifiedCalls2.jpg" alt="verifiedCalls" id="panel">
        <img src="../../assets/img/verifiedCalls-page/verifiedCalls3.jpg" alt="verifiedCalls" id="panel">
        <img src="../../assets/img/verifiedCalls-page/verifiedCalls4.jpg" alt="verifiedCalls" id="panel">
        <img src="../../assets/img/verifiedCalls-page/verifiedCalls5.jpg" alt="verifiedCalls" id="panel">
        <img src="../../assets/img/verifiedCalls-page/verifiedCalls6.jpg" alt="verifiedCalls" id="panel">
      </div>
  </section>
...
<script src="./verifiedCalls.js"></script>
